...
const Shipments = () => {
  ...
  // Users can view but not manage shipments
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            {canManageShipments ? "Track and manage shipments from approved POs" : "Track the status of your shipments"}
          </p>
        </div>
        {canManageShipments && (
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  {canManageShipments && <TableHead className="w-[50px]"></TableHead>}
                </TableRow>
              </TableHeader>
              <TableBody>
                {filteredShipments.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={canManageShipments ? 7 : 6} className="h-32 text-center">
                      <div className="flex flex-col items-center gap-2 text-muted-foreground">
                        <Truck className="h-8 w-8 opacity-50" />
                        <p>No shipments found</p>
                        {canManageShipments && approvedPOs.length > 0 ? (
                          <Button variant="outline" size="sm" onClick={() => setIsCreateDialogOpen(true)}>
                            Create your first shipment
                          </Button>
                        ) : (
                          <p className="text-sm">No shipments to display yet</p>
                        )}
                      </div>
                    </TableCell>
                  </TableRow>
